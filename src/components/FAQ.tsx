...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Первичная консультация и заполнение анкеты — бесплатно. Часть услуг по оформлению документов также предоставляется безвозмездно. О стоимости дополнительных услуг специалист расскажет на консультации.",
  },
  {
